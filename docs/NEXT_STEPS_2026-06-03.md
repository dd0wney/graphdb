...
6. **Current state (2026-06-12): TRACK S IS CLOSED.** Read § Track S. Waves 1 (#372–378) + 2 (#379/#380) + 3 (H-6 #385, H-5 #387, M-8 #383, M-2 #384, M-7 #390) shipped earlier; the design-gated remainder closed 2026-06-12: **M-14 #395, M-1 #396 (Option A, all 3 backends), M-15-OSS #397, M-7-followup #398, H-3 #399**, plus the client releases (`python-sdk/v0.1.0`, `ts-client/v1.0.0`). The track's only tail: M-15 enterprise-side manifest tooling (cross-repo) and the PyPI-publish decision. **No critical path is forced again** — next-track candidates per the standing queue: productization/operability (never had a wave; onboarding docs + single-node framing), the real-corpus coi-screen run (Milestone-1-proper, likeliest source of new evidence), GraphQL index-level pagination, the batched-WAL default sweep, CI hygiene (`cmd/...` test allowlist, gofmt lint gap). Don't re-commission a security audit without new evidence.
