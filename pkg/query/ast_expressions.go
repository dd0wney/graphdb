...
// EvalValue returns the raw evaluation result (used for projection, SET RHS,
// CALL args); Eval coerces to bool (used for WHERE / AND / OR / comparison).
// All concrete implementations satisfy both — the dual-eval pattern.
