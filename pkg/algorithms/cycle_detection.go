...
func DetectCycles(graph storage.StorageReader) ([]Cycle, error) {
...
func DetectCyclesForTenant(graph storage.StorageReader, tenantID string) ([]Cycle, error) {
...
// (tenant-blind).
func DetectCyclesWithOptions(graph storage.StorageReader, opts CycleDetectionOptions) ([]Cycle, error) {
...
func DetectCyclesWithOptionsForTenant(graph storage.StorageReader, opts CycleDetectionOptions, tenantID string) ([]Cycle, error) {
...
func HasCycle(graph storage.StorageReader) (bool, error) {
...
func HasCycleForTenant(graph storage.StorageReader, tenantID string) (bool, error) {
