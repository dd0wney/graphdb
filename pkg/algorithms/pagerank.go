...
// PageRankForTenant.
func PageRank(graph storage.StorageReader, opts PageRankOptions) (*PageRankResult, error) {
...
func PageRankForTenant(graph storage.StorageReader, opts PageRankOptions, tenantID string) (*PageRankResult, error) {
...
func findTopNodes(graph storage.StorageReader, scores map[uint64]float64, n int) []RankedNode {
